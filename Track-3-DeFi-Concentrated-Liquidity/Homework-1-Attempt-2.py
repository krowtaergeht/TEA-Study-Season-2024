...
# Increase the height of the padding between subplots
...
# Add the text to the third subplot
axs[2].text(0.5, 0.5, wrapped_caption, ha='center', va='center', wrap=True)

# Hide the x and y axis of the third subplot
axs[2].axis('off')
